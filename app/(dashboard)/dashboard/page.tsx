...
function Card({ image, icon, title, subtitle }: { image: string; icon: React.ReactNode; title: string; subtitle: string }) {
  return (
     <div className="w-full h-64 bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-xl shadow-pink-200 hover:shadow-lg transition-shadow duration-300 flex flex-col">
